...
#define STRING_CONFIG_H_AUTHOR "(Nightly, Ender-5 Pro)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Nightly Ender5Pro"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 95.5 }
